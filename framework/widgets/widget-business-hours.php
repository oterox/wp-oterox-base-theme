 ...
 * 
 * Plugin Name: Ox_Widget_Business_Hours
 * Plugin URI: http://www.oterox.com
...
class Ox_Widget_Business_Hours extends WP_Widget {
	...
	public function __construct() {
		parent::__construct( 
			...
			__( 'OX Test Widget', 'ox' ),
			array(
				'classname'   => 'widget-business-hours',
				'description' => __( 'A custom widget that displays business hours.', 'ox' )
			) 
		);
	}
	...
	public function form( $instance ) {
		...
		<!-- Title -->
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'ox' ); ?></label>
			<input type="text" class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" value="<?php echo esc_attr( $instance['title'] ); ?>">
		</p>

		<!-- Description -->
		<p>
			<label for="<?php echo $this->get_field_id( 'hours_description' ); ?>"><?php _e( 'Description:', 'ox' ); ?></label>
		...
		<!-- Monday-Friday -->
		<p>
			<label for="<?php echo $this->get_field_id( 'hours_monday_friday' ); ?>"><?php _e( 'Monday-Friday:', 'ox' ); ?></label>
		...
		<!-- Saturday -->
		<p>
			<label for="<?php echo $this->get_field_id( 'hours_saturday' ); ?>"><?php _e( 'Saturday:', 'ox' ); ?></label>
		...
		<!-- Sunday -->
		<p>
			<label for="<?php echo $this->get_field_id( 'hours_sunday' ); ?>"><?php _e( 'Sunday:', 'ox' ); ?></label>
	...
	public function widget( $args, $instance ) {
		...
		if ( $hours_monday_friday ) : ?>
			<li>
				<span><?php _e( 'Monday-Friday: ', 'ox' ); ?></span>
...
add_action( 'widgets_init', create_function( '', 'register_widget( "Ox_Widget_Business_Hours" );' ) );
?>